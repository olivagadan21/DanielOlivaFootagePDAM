...
import '../../bloc/producto/list/productos_bloc.dart';
import '../../models/producto/producto_response.dart';
import '../../repository/producto/producto_repository.dart';
import '../../repository/producto/producto_repository_impl.dart';
import '../../style/styles.dart';
import '../widgets/error_page.dart';
import 'detalle_producto.dart';

class Buscado extends StatefulWidget  {

  const Buscado({ Key? key }) : super(key: key);
...
class _InicioScreenState extends State<Buscado> {
      ...
      if (state is ProductosInitial) {
        ...
        return Column(
          children: [
            ...
            _createPopularView(context, state.productos),
          ],
        );
      } else {
            ...
            SizedBox(
              ...
              child: FractionallySizedBox(
                ...
                child: Card(
                  ...
                  child: InkWell(
                    onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context) => DetalleProducto(productoResponse: producto,)));},
                    child: SizedBox(
                      child: Column(
                        children: [
                          Padding(
                            ...
                            child: Row(
                              children: [
                                Container(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(20),
                                    child: Image(image: NetworkImage(producto.usuario.avatar), width: 30,)
                                  )
                                ),
                                Padding(
                          ...
                          Image(image: NetworkImage(producto.foto)),
                          Padding(
